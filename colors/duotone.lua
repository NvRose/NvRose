...
vim.api.nvim_set_hl(0, "@parameter", { fg = "#F2CDCD" })
...
vim.api.nvim_set_hl(0, "DiagnosticHint", { bg = "#1e1e2e", fg = "#94E2D5" })
vim.api.nvim_set_hl(0, "DiagnosticInfo", { bg = "#1e1e2e", fg = "#89DCEB" })
vim.api.nvim_set_hl(0, "DiagnosticWarn", { bg = "#1e1e2e", fg = "#F9E2AF" })
vim.api.nvim_set_hl(0, "DiagnosticError", { bg = "#1e1e2e", fg = "#F38BA8" })
...
vim.api.nvim_set_hl(0, "NormalMode", { bg = "#a6e3a1", fg = "#1e1e2e", bold = true })
vim.api.nvim_set_hl(0, "TermMode", { bg = "#b4befe", fg = "#1e1e2e", bold = true })
vim.api.nvim_set_hl(0, "InsertMode", { bg = "#89b4fa", fg = "#1e1e2e", bold = true })
vim.api.nvim_set_hl(0, "CmdMode", { bg = "#F9E2AF", fg = "#1e1e2e", bold = true })
vim.api.nvim_set_hl(0, "VisualMode", { bg = "#fab387", fg = "#1e1e2e", bold = true })
